...
public class GenerationSettings {
   ...
   public static final MapCodec<GenerationSettings> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
      RecordCodecBuilder var10001 = ConfiguredSurfaceBuilder.REGISTRY_CODEC.fieldOf("surface_builder").flatXmap(Codecs.createPresentValueChecker(), Codecs.createPresentValueChecker()).forGetter((generationSettings) -> {
      ...
      RecordCodecBuilder var1 = Codec.simpleMap(var10002, var10003.promotePartial(Util.addPrefix("Carver: ", var10005::error)).flatXmap(Codecs.createPresentValuesChecker(), Codecs.createPresentValuesChecker()), StringIdentifiable.toKeyable(GenerationStep.Carver.values())).fieldOf("carvers").forGetter((generationSettings) -> {
         return generationSettings.carvers;
      });
      var10003 = ConfiguredFeature.field_26756;
      var10005 = LOGGER;
      Objects.requireNonNull(var10005);
      RecordCodecBuilder var2 = var10003.promotePartial(Util.addPrefix("Feature: ", var10005::error)).flatXmap(Codecs.createPresentValuesChecker(), Codecs.createPresentValuesChecker()).listOf().fieldOf("features").forGetter((generationSettings) -> {
      ...
      return instance.group(var10001, var1, var2, var10004.promotePartial(Util.addPrefix("Structure start: ", var10006::error)).fieldOf("starts").flatXmap(Codecs.createPresentValuesChecker(), Codecs.createPresentValuesChecker()).forGetter((generationSettings) -> {

...
public final class NoiseChunkGenerator extends ChunkGenerator {
   ...
   class NoodleCavesSampler implements WeightSampler {
      ...
      public NoodleCavesSampler(ChunkPos pos, int minY) {
         ...
         this.frequencyNoiseInterpolator = new NoiseInterpolator(var10003, var10004, var10005, pos, minY, var10008::sampleFrequencyNoise);
         ...
         Objects.requireNonNull(var10008);
         this.weightReducingNoiseInterpolator = new NoiseInterpolator(var10003, var10004, var10005, pos, minY, var10008::sampleWeightReducingNoise);
         var10003 = NoiseChunkGenerator.this.noiseSizeX;
         var10004 = NoiseChunkGenerator.this.noiseSizeY;
         var10005 = NoiseChunkGenerator.this.noiseSizeZ;
         var10008 = NoiseChunkGenerator.this.noodleCavesGenerator;
         Objects.requireNonNull(var10008);
         this.firstWeightNoiseinterpolator = new NoiseInterpolator(var10003, var10004, var10005, pos, minY, var10008::sampleFirstWeightNoise);
         var10003 = NoiseChunkGenerator.this.noiseSizeX;
         var10004 = NoiseChunkGenerator.this.noiseSizeY;
         var10005 = NoiseChunkGenerator.this.noiseSizeZ;
         var10008 = NoiseChunkGenerator.this.noodleCavesGenerator;
         Objects.requireNonNull(var10008);
         this.secondWeightNoiseInterpolator = new NoiseInterpolator(var10003, var10004, var10005, pos, minY, var10008::sampleSecondWeightNoise);
      }
   ...
   private class OreVeinSource implements BlockSource {
      ...
      public OreVeinSource(ChunkPos pos, int minY, long seed) {
         ...
         Objects.requireNonNull(var10008);
         this.oreFrequencyNoiseInterpolator = new NoiseInterpolator(var10003, var10004, var10005, pos, minY, var10008::sampleOreFrequencyNoise);
         var10003 = NoiseChunkGenerator.this.noiseSizeX;
         var10004 = NoiseChunkGenerator.this.noiseSizeY;
         var10005 = NoiseChunkGenerator.this.noiseSizeZ;
         var10008 = NoiseChunkGenerator.this.oreVeinGenerator;
         Objects.requireNonNull(var10008);
         this.firstOrePlacementNoiseInterpolator = new NoiseInterpolator(var10003, var10004, var10005, pos, minY, var10008::sampleFirstOrePlacementNoise);
         var10003 = NoiseChunkGenerator.this.noiseSizeX;
         var10004 = NoiseChunkGenerator.this.noiseSizeY;
         var10005 = NoiseChunkGenerator.this.noiseSizeZ;
         var10008 = NoiseChunkGenerator.this.oreVeinGenerator;
         Objects.requireNonNull(var10008);
         this.secondOrePlacementNoiseInterpolator = new NoiseInterpolator(var10003, var10004, var10005, pos, minY, var10008::sampleSecondOrePlacementNoise);
         this.seed = seed;
      }

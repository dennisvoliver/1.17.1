...
public class ConfiguredFeatures {
   ...
   static {
      ...
      PILE_ICE = register("pile_ice", Feature.BLOCK_PILE.configure(new BlockPileFeatureConfig(new WeightedBlockStateProvider(pool().add(ConfiguredFeatures.States.BLUE_ICE, 1).add(ConfiguredFeatures.States.PACKED_ICE, 5)))));
      PILE_PUMPKIN = register("pile_pumpkin", Feature.BLOCK_PILE.configure(new BlockPileFeatureConfig(new WeightedBlockStateProvider(pool().add(ConfiguredFeatures.States.PUMPKIN, 19).add(ConfiguredFeatures.States.JACK_O_LANTERN, 1)))));
      ...
      ORE_DIAMOND = register("ore_diamond", (ConfiguredFeature)((ConfiguredFeature)Feature.ORE.configure(new OreFeatureConfig(DIAMOND_ORE_TARGETS, 8)).uniformRange(YOffset.getBottom(), YOffset.fixed(15))).spreadHorizontally());
      ...
      ORE_EMERALD = register("ore_emerald", (ConfiguredFeature)((ConfiguredFeature)((ConfiguredFeature)Feature.REPLACE_SINGLE_BLOCK.configure(new EmeraldOreFeatureConfig(EMERALD_ORE_TARGETS)).uniformRange(YOffset.fixed(4), YOffset.fixed(31))).spreadHorizontally()).repeat(UniformIntProvider.create(3, 8)));
      ...
      RANDOM_BERRIES_CAVE_VINES_BODY_PROVIDER = new WeightedBlockStateProvider(pool().add(Blocks.CAVE_VINES_PLANT.getDefaultState(), 4).add((BlockState)Blocks.CAVE_VINES_PLANT.getDefaultState().with(CaveVines.BERRIES, true), 1));
      RANDOM_AGE_CAVE_VINES_HEAD_PROVIDER = new RandomizedIntBlockStateProvider(new WeightedBlockStateProvider(pool().add(Blocks.CAVE_VINES.getDefaultState(), 4).add((BlockState)Blocks.CAVE_VINES.getDefaultState().with(CaveVines.BERRIES, true), 1)), CaveVinesHeadBlock.AGE, UniformIntProvider.create(17, 25));
   ...
   public static final class Configs {
      ...
      static {
         ...
         TAIGA_GRASS_CONFIG = (new RandomPatchFeatureConfig.Builder(new WeightedBlockStateProvider(ConfiguredFeatures.pool().add(ConfiguredFeatures.States.GRASS, 1).add(ConfiguredFeatures.States.FERN, 4)), SimpleBlockPlacer.INSTANCE)).tries(32).build();
         LUSH_GRASS_CONFIG = (new RandomPatchFeatureConfig.Builder(new WeightedBlockStateProvider(ConfiguredFeatures.pool().add(ConfiguredFeatures.States.GRASS, 3).add(ConfiguredFeatures.States.FERN, 1)), SimpleBlockPlacer.INSTANCE)).blacklist(ImmutableSet.of(ConfiguredFeatures.States.PODZOL)).tries(32).build();
         DEFAULT_FLOWER_CONFIG = (new RandomPatchFeatureConfig.Builder(new WeightedBlockStateProvider(ConfiguredFeatures.pool().add(ConfiguredFeatures.States.POPPY, 2).add(ConfiguredFeatures.States.DANDELION, 1)), SimpleBlockPlacer.INSTANCE)).tries(64).build();
         ...
         CRIMSON_ROOTS_CONFIG = new BlockPileFeatureConfig(new WeightedBlockStateProvider(ConfiguredFeatures.pool().add(ConfiguredFeatures.States.CRIMSON_ROOTS, 87).add(ConfiguredFeatures.States.CRIMSON_FUNGUS, 11).add(ConfiguredFeatures.States.WARPED_FUNGUS, 1)));
         WARPED_ROOTS_CONFIG = new BlockPileFeatureConfig(new WeightedBlockStateProvider(ConfiguredFeatures.pool().add(ConfiguredFeatures.States.WARPED_ROOTS, 85).add(ConfiguredFeatures.States.CRIMSON_ROOTS, 1).add(ConfiguredFeatures.States.WARPED_FUNGUS, 13).add(ConfiguredFeatures.States.CRIMSON_FUNGUS, 1)));

...
public class EnchantmentHelper {
   ...
   public static int getLevelFromNbt(NbtCompound nbt) {
      return MathHelper.clamp((int)nbt.getInt("lvl"), (int)0, (int)255);
   }
   ...
   public static Map<Enchantment, Integer> fromNbt(NbtList list) {
      ...
      for(int i = 0; i < list.size(); ++i) {
         ...
         Registry.ENCHANTMENT.getOrEmpty(getIdFromNbt(nbtCompound)).ifPresent((enchantment) -> {
            map.put(enchantment, getLevelFromNbt(nbtCompound));
         });
      }

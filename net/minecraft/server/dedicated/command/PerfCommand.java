...
public class PerfCommand {
   ...
   private static void saveReport(ServerCommandSource source, Path tempProfilingDirectory, MinecraftServer server) {
      ...
      String string3;
      try {
         string3 = FileNameUtil.getNextUniqueName(RecordDumper.DEBUG_PROFILING_DIRECTORY, string, ".zip");
      ...
      ZipCompressor zipCompressor = new ZipCompressor(RecordDumper.DEBUG_PROFILING_DIRECTORY.resolve(string3));
      ...
      try {
         ...
         LOGGER.warn((String)"Failed to delete temporary profiling file {}", (Object)tempProfilingDirectory, (Object)var9);
      }

...
public class ServerPlayerEntity extends PlayerEntity {
   ...
   public boolean dropSelectedItem(boolean entireStack) {
      ...
      this.currentScreenHandler.getSlotIndex(playerInventory, playerInventory.selectedSlot).ifPresent((i) -> {
         this.currentScreenHandler.setPreviousTrackedSlot(i, playerInventory.getMainHandStack());
      });

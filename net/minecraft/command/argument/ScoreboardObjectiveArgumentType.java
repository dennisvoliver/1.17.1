...
public class ScoreboardObjectiveArgumentType implements ArgumentType<String> {
   ...
   private static final DynamicCommandExceptionType UNKNOWN_OBJECTIVE_EXCEPTION = new DynamicCommandExceptionType((name) -> {
      return new TranslatableText("arguments.objective.notFound", new Object[]{name});
   });
   private static final DynamicCommandExceptionType READONLY_OBJECTIVE_EXCEPTION = new DynamicCommandExceptionType((name) -> {
      return new TranslatableText("arguments.objective.readonly", new Object[]{name});
   });
   public static final DynamicCommandExceptionType LONG_NAME_EXCEPTION = new DynamicCommandExceptionType((maxLength) -> {
      return new TranslatableText("commands.scoreboard.objectives.add.longName", new Object[]{maxLength});
   });
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
      if (context.getSource() instanceof ServerCommandSource) {
         return CommandSource.suggestMatching((Iterable)((ServerCommandSource)context.getSource()).getServer().getScoreboard().getObjectiveNames(), builder);

...
public class IdentifierArgumentType implements ArgumentType<Identifier> {
   ...
   private static final DynamicCommandExceptionType UNKNOWN_ADVANCEMENT_EXCEPTION = new DynamicCommandExceptionType((id) -> {
      return new TranslatableText("advancement.advancementNotFound", new Object[]{id});
   });
   private static final DynamicCommandExceptionType UNKNOWN_RECIPE_EXCEPTION = new DynamicCommandExceptionType((id) -> {
      return new TranslatableText("recipe.notFound", new Object[]{id});
   });
   private static final DynamicCommandExceptionType UNKNOWN_PREDICATE_EXCEPTION = new DynamicCommandExceptionType((id) -> {
      return new TranslatableText("predicate.unknown", new Object[]{id});
   });
   private static final DynamicCommandExceptionType UNKNOWN_ATTRIBUTE_EXCEPTION = new DynamicCommandExceptionType((id) -> {
      return new TranslatableText("attribute.unknown", new Object[]{id});
   });
   private static final DynamicCommandExceptionType UNKNOWN_ITEM_MODIFIER_EXCEPTION = new DynamicCommandExceptionType((id) -> {
      return new TranslatableText("item_modifier.unknown", new Object[]{id});
   });

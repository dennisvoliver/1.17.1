...
public class EnchantmentArgumentType implements ArgumentType<Enchantment> {
   ...
   public static final DynamicCommandExceptionType UNKNOWN_ENCHANTMENT_EXCEPTION = new DynamicCommandExceptionType((id) -> {
      return new TranslatableText("enchantment.unknown", new Object[]{id});
   });

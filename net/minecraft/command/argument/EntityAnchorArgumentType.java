...
public class EntityAnchorArgumentType implements ArgumentType<EntityAnchorArgumentType.EntityAnchor> {
   ...
   private static final DynamicCommandExceptionType INVALID_ANCHOR_EXCEPTION = new DynamicCommandExceptionType((name) -> {
      return new TranslatableText("argument.anchor.invalid", new Object[]{name});
   });
   ...
   public static enum EntityAnchor {
      ...
      static final Map<String, EntityAnchorArgumentType.EntityAnchor> anchors = (Map)Util.make(Maps.newHashMap(), (map) -> {

...
public class TimeArgumentType implements ArgumentType<Integer> {
   ...
   private static final DynamicCommandExceptionType INVALID_COUNT_EXCEPTION = new DynamicCommandExceptionType((time) -> {
      return new TranslatableText("argument.time.invalid_tick_count", new Object[]{time});
   });

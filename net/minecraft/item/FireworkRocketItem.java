...
public class FireworkRocketItem extends Item {
   ...
   public static enum Type {
      ...
      private static final FireworkRocketItem.Type[] TYPES = (FireworkRocketItem.Type[])Arrays.stream(values()).sorted(Comparator.comparingInt((type) -> {
         return type.id;
      })).toArray((i) -> {
         return new FireworkRocketItem.Type[i];
      });

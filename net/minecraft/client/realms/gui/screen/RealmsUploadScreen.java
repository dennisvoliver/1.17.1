   ...
   private void upload() {
      ...
      (new Thread(() -> {
         ...
         try {
            ...
            if (!this.cancelled) {
               if (!this.verify(file)) {
                  ...
                  if (SizeUnit.humanReadableSize(m, sizeUnit).equals(SizeUnit.humanReadableSize(5368709120L, sizeUnit2)) && sizeUnit != SizeUnit.B) {
                     ...
                     this.setStatusTexts(new TranslatableText("mco.upload.size.failure.line1", new Object[]{this.selectedLevel.getDisplayName()}), new TranslatableText("mco.upload.size.failure.line2", new Object[]{SizeUnit.humanReadableSize(m, sizeUnit3), SizeUnit.humanReadableSize(5368709120L, sizeUnit3)}));
                     return;
                  }

                  this.setStatusTexts(new TranslatableText("mco.upload.size.failure.line1", new Object[]{this.selectedLevel.getDisplayName()}), new TranslatableText("mco.upload.size.failure.line2", new Object[]{SizeUnit.humanReadableSize(m, sizeUnit), SizeUnit.humanReadableSize(5368709120L, sizeUnit2)}));
                  return;
               }
               ...
               fileUpload.upload((result) -> {
                  if (result.statusCode >= 200 && result.statusCode < 300) {
                     ...
                     this.setStatusTexts(new TranslatableText("mco.upload.failed", new Object[]{result.errorMessage}));
                  } else {
                     this.setStatusTexts(new TranslatableText("mco.upload.failed", new Object[]{result.statusCode}));
                  }
            ...
            this.setStatusTexts(new TranslatableText("mco.upload.failed", new Object[]{var21.getMessage()}));
            return;
         } catch (RealmsServiceException var22) {
            this.setStatusTexts(new TranslatableText("mco.upload.failed", new Object[]{var22.toString()}));
            return;

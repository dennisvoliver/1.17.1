...
public class RealmsConfigureWorldScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.switchMinigameButton = (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.buttonLeft(0), row(13) - 5, 100, 20, new TranslatableText("mco.configure.world.buttons.switchminigame"), (button) -> {
         this.client.setScreen(new RealmsSelectWorldTemplateScreen(new TranslatableText("mco.template.title.minigame"), this::switchMinigame, RealmsServer.WorldType.MINIGAME));
      }));
   ...
   private void drawExpiring(MatrixStack matrices, int x, int y, int mouseX, int mouseY, int remainingDays) {
      ...
      if (mouseX >= x && mouseX <= x + 9 && mouseY >= y && mouseY <= y + 27) {
         if (remainingDays <= 0) {
            ...
            this.tooltip = new TranslatableText("mco.selectServer.expires.days", new Object[]{remainingDays});
         }
      }

...
public class InGameHud extends DrawableHelper {
   ...
   public void renderExperienceBar(MatrixStack matrices, int x) {
      ...
      if (this.client.player.experienceLevel > 0) {
         ...
         this.getTextRenderer().draw(matrices, (String)string, (float)(m + 1), (float)n, 0);
         this.getTextRenderer().draw(matrices, (String)string, (float)(m - 1), (float)n, 0);
         this.getTextRenderer().draw(matrices, (String)string, (float)m, (float)(n + 1), 0);
         this.getTextRenderer().draw(matrices, (String)string, (float)m, (float)(n - 1), 0);
   ...
   public void renderHeldItemTooltip(MatrixStack matrices) {
      ...
      if (this.heldItemTooltipFade > 0 && !this.currentStack.isEmpty()) {
         ...
         if (l > 0) {
            ...
            this.getTextRenderer().drawWithShadow(matrices, (Text)mutableText, (float)j, (float)k, 16777215 + (l << 24));
            RenderSystem.disableBlend();
         }
      }
   ...
   public void renderDemoTimer(MatrixStack matrices) {
      ...
      int i = this.getTextRenderer().getWidth((StringVisitable)text2);
      this.getTextRenderer().drawWithShadow(matrices, (Text)text2, (float)(this.scaledWidth - i - 10), 5.0F, 16777215);
      this.client.getProfiler().pop();
   }

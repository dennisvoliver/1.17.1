...
public class ConfirmScreen extends Screen {
   ...
   protected void addButtons(int y) {
      this.addButton(new ButtonWidget(this.width / 2 - 155, y, 150, 20, this.yesTranslated, (button) -> {
         this.callback.accept(true);
      }));
      this.addButton(new ButtonWidget(this.width / 2 - 155 + 160, y, 150, 20, this.noTranslated, (button) -> {

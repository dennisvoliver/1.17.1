   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      for(m = 0; m < this.text.length; ++m) {
         ...
         if (string2 != null) {
            ...
            this.client.textRenderer.draw(string2, n, (float)(m * 10 - this.text.length * 5), i, false, matrix4f, immediate, false, 0, LightmapTextureManager.MAX_LIGHT_COORDINATE, false);
            if (m == this.currentRow && j >= 0 && bl2) {
               ...
               if (j >= string2.length()) {
                  this.client.textRenderer.draw("_", (float)t, (float)l, i, false, matrix4f, immediate, false, 0, LightmapTextureManager.MAX_LIGHT_COORDINATE, false);
               }
            }
         }
      }

...
public class BeaconScreen extends HandledScreen<BeaconScreenHandler> {
   ...
   private <T extends ClickableWidget & BeaconScreen.BeaconButtonWidget> void addButton(T button) {
      ...
      this.buttons.add((BeaconScreen.BeaconButtonWidget)button);
   }
   ...
   protected void drawForeground(MatrixStack matrices, int mouseX, int mouseY) {
      ...
      while(var4.hasNext()) {
         BeaconScreen.BeaconButtonWidget beaconButtonWidget = (BeaconScreen.BeaconButtonWidget)var4.next();
   ...
   @Environment(EnvType.CLIENT)
   private abstract static class BaseButtonWidget extends PressableWidget implements BeaconScreen.BeaconButtonWidget {

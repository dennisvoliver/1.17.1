...
public class LanguageOptionsScreen extends GameOptionsScreen {
   ...
   protected void init() {
      ...
      this.addDrawableChild(new ButtonWidget(this.width / 2 - 155 + 160, this.height - 38, 150, 20, ScreenTexts.DONE, (button) -> {
         LanguageOptionsScreen.LanguageSelectionListWidget.LanguageEntry languageEntry = (LanguageOptionsScreen.LanguageSelectionListWidget.LanguageEntry)this.languageSelectionList.getSelectedOrNull();

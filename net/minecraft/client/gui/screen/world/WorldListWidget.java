...
public class WorldListWidget extends AlwaysSelectedEntryListWidget<WorldListWidget.Entry> {
   ...
   public Optional<WorldListWidget.Entry> getSelectedAsOptional() {
      return Optional.ofNullable((WorldListWidget.Entry)this.getSelectedOrNull());
   }
            ...
            try {
               ...
               try {
                  ...
                  if (generatorOptions.isLegacyCustomizedType()) {
                     this.client.setScreen(new ConfirmScreen((confirmed) -> {
                        this.client.setScreen((Screen)(confirmed ? new CreateWorldScreen(this.screen, levelInfo, generatorOptions, path, dataPackSettings, impl) : this.screen));

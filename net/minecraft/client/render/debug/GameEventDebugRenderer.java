      ...
      if (world == null) {
         ...
         while(var14.hasNext()) {
            ...
            listener3.getPos(world).ifPresent((pos) -> {
               Vec3f vec3f = new Vec3f(1.0F, 1.0F, 0.0F);
               WorldRenderer.drawBox(bufferBuilder, (double)((float)pos.getX() - 0.25F) - cameraX, (double)pos.getY() - cameraY, (double)((float)pos.getZ() - 0.25F) - cameraZ, (double)((float)pos.getX() + 0.25F) - cameraX, (double)pos.getY() - cameraY + 1.0D, (double)((float)pos.getZ() + 0.25F) - cameraZ, vec3f.getX(), vec3f.getY(), vec3f.getZ(), 0.35F);
            });
         }

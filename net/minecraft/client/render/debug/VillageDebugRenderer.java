...
public class VillageDebugRenderer implements DebugRenderer.Renderer {
   ...
   private void drawBrain(VillageDebugRenderer.Brain brain, double cameraX, double cameraY, double cameraZ) {
      ...
      Iterator var13;
      if (bl) {
         for(var13 = brain.runningTasks.iterator(); var13.hasNext(); ++i) {
      ...
      if (bl) {
         for(var13 = brain.possibleActivities.iterator(); var13.hasNext(); ++i) {
            string4 = (String)var13.next();
      ...
      if (bl) {
         for(var13 = brain.gossips.iterator(); var13.hasNext(); ++i) {
            string4 = (String)var13.next();
            if (string4.startsWith(brain.name)) {
      ...
      if (bl) {
         for(var13 = Lists.reverse(brain.memories).iterator(); var13.hasNext(); ++i) {
            string4 = (String)var13.next();
   ...
   private Map<BlockPos, List<String>> getGhostPointsOfInterest() {
      ...
      while(var2.hasNext()) {
         ...
         Iterator var4 = Iterables.concat(brain.pointsOfInterest, brain.potentialJobSites).iterator();

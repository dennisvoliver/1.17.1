...
public class BufferBuilder extends FixedColorVertexConsumer implements BufferVertexConsumer {
   ...
   public void vertex(float x, float y, float z, float red, float green, float blue, float alpha, float u, float v, int overlay, int light, float normalX, float normalY, float normalZ) {
      if (this.colorFixed) {
         ...
         this.putShort(j + 0, (short)(light & (LightmapTextureManager.MAX_BLOCK_LIGHT_COORDINATE | '／')));
         this.putShort(j + 2, (short)(light >> 16 & (LightmapTextureManager.MAX_BLOCK_LIGHT_COORDINATE | '／')));

...
public class ItemModels {
   ...
   public Sprite getModelParticleSprite(ItemStack stack) {
      ...
      return bakedModel == this.modelManager.getMissingModel() && stack.getItem() instanceof BlockItem ? this.modelManager.getBlockModels().getModelParticleSprite(((BlockItem)stack.getItem()).getBlock().getDefaultState()) : bakedModel.getParticleSprite();
   }
